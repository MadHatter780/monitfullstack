...
var mqtt = (() => {
                ...
                (Lt = {
                    now:
                        typeof performance < "u"
                            ...
                            : void 0,
                    timing:
                        typeof performance < "u" ? performance.timing : void 0,
                });
            Lt.now === void 0 &&
                ((bs = Date.now()),
                Lt.timing &&
    ...
    function Xg() {
        ...
        function g(y) {
            ...
            return (
                E === 1
                    ? ((w = y[S - 1]),
                      I.push(t[w >> 2] + t[(w << 4) & 63] + "=="))
                    : E === 2 &&
                      ((w = (y[S - 2] << 8) + y[S - 1]),
                      I.push(
                          t[w >> 10] + t[(w >> 4) & 63] + t[(w << 2) & 63] + "="
                      )),
                I.join("")
            );
        }
    ...
    function ey() {
        ...
        function a(p, u, f) {
            ...
            if (
                ...
                (typeof SharedArrayBuffer < "u" &&
                    (Ye(p, SharedArrayBuffer) ||
                        (p && Ye(p.buffer, SharedArrayBuffer))))
            )
                return w(p, u, f);
            if (typeof p == "number")
                throw new TypeError(
        ...
        function S(p) {
            ...
            if (p.length !== void 0)
                return typeof p.length != "number" || gs(p.length)
                    ? o(0)
                    : g(p);
        ...
        function fi(p, u, f) {
            throw Math.floor(p) !== p
                ? (Mr(p, f),
                  new xr.ERR_OUT_OF_RANGE(f || "offset", "an integer", p))
                : u < 0
...
`;
        ...
        Ss.exports.promisify.custom = Symbol.for(
        ...
        function Hy(t, e) {
            ...
            if (r === "hex" && i % 2 !== 0)
                throw new Ur(
                    "encoding",
                    e,
                    `is invalid for data of length ${i}`
                );
        }
    ...
    var tt = M((hI, Pf) => {
        ...
        function cb(t) {
            ...
            let e = t._writableState,
                r = t._readableState;
            return typeof e?.closed == "boolean" ||
        ...
        function hb(t) {
            ...
            return (
                ...
                ((e = t.req) === null || e === void 0
                    ? void 0
                    : e.upgradeOrConnect) === void 0
            );
        }
        function db(t) {
            if (!et(t)) return null;
        ...
        function gb(t) {
            ...
            return !!(
                ...
                ((e =
                            ...
                            (n =
                                (o =
                                    (s = t[_f]) !== null && s !== void 0
                                        ? s
                                        : t.readableErrored) !== null &&
                                o !== void 0
                                    ? o
                                    : t.writableErrored) !== null &&
                            n !== void 0
                                ? n
                                : (a = t._readableState) === null ||
                                  a === void 0
                                ? void 0
                    ...
                    ? e
                    : !((h = t._writableState) === null || h === void 0) &&
                      h.errored)
            );
        }
        Pf.exports = {
    ...
    var vt = M((_I, Ns) => {
        ...
        function jf(t, e, r) {
            ...
            Pb(t)
                ...
                E
                    ? qt.nextTick(I)
                    : (a != null && a.errorEmitted) ||
                      (l != null && l.errorEmitted)
                    ? h || qt.nextTick(C)
                    : ((!o && (!h || Of(t)) && (d || Lf(t) === !1)) ||
                          (!s && (!h || Lf(t)) && (y || Of(t) === !1)) ||
                          (l && t.req && t.aborted)) &&
                ...
                if (
                    ((n = () => {
                        (i = !0),
                            r.call(
                                t,
                                new Df(void 0, { cause: e.signal.reason })
                            );
                    }),
                    e.signal.aborted)
                )
    ...
    function Cc(t, e, r) {
        ...
        if (
            ...
            (typeof SharedArrayBuffer < "u" &&
                (St(t, SharedArrayBuffer) ||
                    (t && St(t.buffer, SharedArrayBuffer))))
        )
            return mc(t, e, r);
        if (typeof t == "number")
            throw new TypeError(
        ...
        var n = (function (o) {
            ...
            if (o.length !== void 0)
                return typeof o.length != "number" || Js(o.length)
                    ? Et(0)
                    : Hs(o);
    ...
    function Mc(t) {
        return zs.toByteArray(
            (function (e) {
                if (
                    (e = (e = e.split("=")[0]).trim().replace(Cw, "")).length <
                    2
                )
                    return "";
                for (; e.length % 4 != 0; ) e += "=";
            ...
            (O.prototype.slice = function (t, e) {
                ...
                (O.prototype.readFloatBE = function (t, e) {
                    return (
                        (t >>>= 0),
                        e || we(t, 4, this.length),
                        Dr.read(this, t, !1, 23, 4)
                    );
                }),
                (O.prototype.readDoubleLE = function (t, e) {
                    return (
                        (t >>>= 0),
                        e || we(t, 8, this.length),
                        Dr.read(this, t, !0, 52, 8)
                    );
                }),
            ...
            Bw = (function () {
                for (var t = new Array(256), e = 0; e < 16; ++e)
                    for (var r = 16 * e, i = 0; i < 16; ++i)
                        t[r + i] =
                            "0123456789abcdef"[e] + "0123456789abcdef"[i];
                return t;
            })();
            At.Buffer;
    ...
    var Zs = M((qT, jc) => {
        ...
        var Nc = Nt(),
            ...
            { Buffer: jw } = (be(), X(me)),
            { ERR_INVALID_ARG_TYPE: Fw, ERR_STREAM_NULL_VALUES: Ww } =
                Ae().codes;
        function $w(t, e, r) {
            let i;
            ...
            async function l() {
                for (;;) {
                    try {
                        let { value: c, done: h } = n
                            ? await i.next()
                            : i.next();
                        if (h) o.push(null);
                        else {
                            let d =
                                c && typeof c.then == "function" ? await c : c;
    ...
    var gi = M((VT, Zc) => {
        ...
        function so(t, e, r) {
            typeof r != "boolean" && (r = e instanceof nt()),
                ...
                t &&
                    t.encoding &&
                    ((this.decoder = new Vc(t.encoding)),
        ...
        F.prototype.pipe = function (t, e) {
            ...
            let o =
                (!e || e.end !== !1) && t !== He.stdout && t !== He.stderr
                    ? a
                    : E;
        ...
        F.prototype.removeAllListeners = function (t) {
            ...
            return (
                (t === "readable" || t === void 0) && He.nextTick(Gc, this), e
            );
        };
        function Gc(t) {
            let e = t._readableState;
        ...
        function __(t, e) {
            e.resumeScheduled ||
                ((e.resumeScheduled = !0), He.nextTick(m_, t, e));
        }
        function m_(t, e) {
            H("resume", e.reading),
                e.reading || t.read(0),
        ...
        function E_(t, e) {
            if (
                ...
                if (
                    ...
                    (!r ||
                        (r.autoDestroy && (r.finished || r.writable === !1))) &&
                        e.destroy();
                }
            }
        }
    ...
    var ho = M((XT, ch) => {
            ...
            (r.writing = !1),
                ...
                e
                    ...
                    : (r.buffered.length > r.bufferedIndex && fo(t, r),
                      i
                          ? r.afterWriteTickInfo !== null &&
                            r.afterWriteTickInfo.cb === n
        ...
        function uo(t) {
            ...
            for (let n = 0; n < r.length; n++) {
                var i;
                r[n](
                    (i = t.errored) !== null && i !== void 0 ? i : new bi("end")
                );
            }
            yn(t);
        }
        function fo(t, e) {
            ...
            if (((e.bufferProcessing = !0), o > 1 && t._writev)) {
                ...
                (l.allBuffers = e.allBuffers),
                    eh(t, e, !0, e.length, l, "", a),
                    yn(e);
            } else {
                do {
        ...
        function ao(t, e) {
            ...
            if ((t.emit("finish"), e.autoDestroy)) {
                let i = t._readableState;
                (!i ||
                    (i.autoDestroy && (i.endEmitted || i.readable === !1))) &&
                    t.destroy();
            }
        }
        I_(ie.prototype, {
    ...
    var En = M((x2, Lh) => {
        ...
        function Mh(t, e, r) {
            ...
            function y(C, R) {
                if (
                    (C &&
                        (!l || l.code === "ERR_STREAM_PREMATURE_CLOSE") &&
                        (l = C),
                    !(!l && !R))
                ) {
    ...
    var Oo = M((j2, Fh) => {
        ...
        Fh.exports = function (...e) {
            ...
            function l(y) {
                let w = s;
                (s = null),
                    w ? w(y) : y ? a.destroy(y) : !g && !d && a.destroy();
            }
            let c = e[0],
                h = R0(e, l),
                d = !!(Nh(c) || qh(c) || pr(c)),
    ...
    var Qh = M((K2, Lo) => {
        ...
        async function X0(t, e, r) {
            ...
            if (
                ...
                throw (
                    (this.once("error", () => {}), await N0(this.destroy(c)), c)
                );
            }
            let o = new Vh(),
                s = o.signal;
    ...
    var No = M((aR, sd) => {
        ...
        var { Buffer: cm } = (be(), X(me)),
            ...
            { streamReturningOperators: Jh, promiseReturningOperators: Xh } =
                Qh(),
            {
    ...
    var ud = M((CR, ld) => {
        ...
        ee.prototype.append = function (e) {
            ...
            if (e.buffer)
                this._appendBuffer(
                    ze.from(e.buffer, e.byteOffset, e.byteLength)
                );
    ...
    var fd = M((LR, Rn) => {
        ...
        function Se(t) {
            ...
            if (typeof t == "function") {
                ...
                let e = function (i) {
                    this._callback &&
                        (this._callback(i), (this._callback = null));
                }.bind(this);
    ...
    var ot = M((xe, Bn) => {
        ...
        function Tm(t) {
            try {
                t
                    ? xe.storage.setItem("debug", t)
                    : xe.storage.removeItem("debug");
            } catch {}
        }
        function Rm() {
            let t;
        ...
        var Pm = fd(),
            ...
            Vo = class t extends km {
                ...
                _parseHeader() {
                    ...
                    return n != null && i !== n
                        ? this._emitError(
                              new Error(V.requiredHeaderFlagsErrors[r])
                          )
                ...
                _parseConnect() {
                    ...
                    (o.username =
                        this._list.readUInt8(this._pos) & V.USERNAME_MASK),
                        (o.password =
                            this._list.readUInt8(this._pos) & V.PASSWORD_MASK),
                        (o.will =
                            this._list.readUInt8(this._pos) & V.WILL_FLAG_MASK);
                    let l = !!(
                            this._list.readUInt8(this._pos) & V.WILL_RETAIN_MASK
                        ),
                        c =
                    ...
                    if (this.settings.protocolVersion === 5) {
                        ...
                        for (
                            ...
                            if (!V.MQTT5_UNSUBACK_CODES[i])
                                return this._emitError(
                                    new Error("Invalid unsuback code")
                                );
                ...
                _parseAuth() {
                    ...
                    if (
                        ...
                        return this._emitError(
                            new Error("Invalid auth reason code")
                        );
                    let r = this._parseProperties();
                    return (
                        Object.getOwnPropertyNames(r).length &&
                ...
                _parseString(e) {
                    ...
                    return (
                        (this._pos += r), D("_parseString: result: %s", n), n
                    );
                }
                _parseStringPair() {
                    return (
                ...
                _parseBuffer() {
                    ...
                    return (
                        (this._pos += e), D("_parseBuffer: result: %o", i), i
                    );
                }
                _parseNum() {
                ...
                _parse4ByteNum() {
                    ...
                    return (
                        (this._pos += 4), D("_parse4ByteNum: result: %s", e), e
                    );
                }
                _parseVarByteNum(e) {
                    D("_parseVarByteNum");
                ...
                _parseProperties() {
                    ...
                    for (; this._pos < i; ) {
                        ...
                        n[s]
                            ? Array.isArray(n[s])
                                ? n[s].push(
                                      this._parseByType(V.propertiesTypes[s])
                                  )
                                : ((n[s] = [n[s]]),
                                  n[s].push(
                                      this._parseByType(V.propertiesTypes[s])
    ...
    var Qo = M(($C, xd) => {
        ...
        Object.defineProperty(kd, "cacheNumbers", {
            ...
            set(t) {
                t
                    ? ((!Pn || Object.keys(Pn).length === 0) && (kn = !0),
                      (Te = Go))
                    : ((kn = !1), (Te = r1));
            },
        });
            ...
            if (s) {
                ...
                if (((y += q.byteLength(s.topic) + 2), (y += 2), s.payload))
                    if (s.payload.length >= 0)
                        ...
                        return e.destroy(new Error("Invalid will payload")), !1;
                if (((S = {}), o === 5)) {
            ...
            if (((c += 2), typeof a == "object" && a.length))
                for (let g = 0; g < a.length; g += 1) {
                    if (typeof a[g] != "string")
                        return (
                            e.destroy(new Error("Invalid unsubscriptions")), !1
                        );
                ...
                if (typeof a == "object" && a.length)
                    for (let y = 0; y < a.length; y += 1) {
                        if (typeof a[y] != "number")
                            return (
                                e.destroy(new Error("Invalid qos vector")), !1
                            );
                        d += 1;
                    }
                else return e.destroy(new Error("Invalid qos vector")), !1;
        ...
        function t1(t, e, r) {
            let i = r ? r.protocolVersion : 4,
                ...
                a = i === 5 ? 1 : 0;
            i !== 5 &&
                e.destroy(new Error("Invalid mqtt version for auth packet"));
            let l = Ii(e, s, r, a);
            return l
                ? ((a += l.length),
            ...
            function i(o, s) {
                ...
                switch (a) {
                    case "byte": {
                        if (typeof s != "boolean")
                            return (
                                t.destroy(new Error(`Invalid ${o}: ${s}`)), !1
                            );
                        l += 1 + 1;
                        break;
                    }
                    ...
                    default:
                        return (
                            t.destroy(new Error(`Invalid property ${o}: ${s}`)),
                            !1
                        );
                }
                return l;
        ...
        function Cd(t, e, r) {
            switch (j.propertiesTypes[e]) {
                ...
                default:
                    return (
                        t.destroy(
                            new Error(`Invalid property ${e} value: ${r}`)
                        ),
                        !1
                    );
            }
        ...
        var f1 = jt(),
            ...
            ea = class {
                ...
                get(e, r) {
                    let i = this._inflights.get(e.messageId);
                    return (
                        i ? r(null, i) : r && r(new Error("missing packet")),
                        this
                    );
                }
                close(e) {
        ...
        var Hd = [0, 16, 128, 131, 135, 144, 145, 151, 153],
            d1 = (t, e, r) => {
                ...
                if (t.options.protocolVersion === 5) {
                    let l;
                    if (
                        (e.properties && (l = e.properties.topicAlias),
                        typeof l < "u")
                    )
                        if (i.length === 0)
                            if (l > 0 && l <= 65535) {
    ...
    var _r = M((at) => {
        ...
        at.applyMixin = g1;
        at.nextTick =
            typeof (B === null || B === void 0 ? void 0 : B.nextTick) ==
            "function"
                ? B.nextTick
                : (t) => {
                      setTimeout(t, 0);
            ...
            switch ((t.log("_handleAck :: packet type", i), i)) {
                ...
                case "suback": {
                    ...
                    for (let l = 0; l < a.length; l++) {
                        ...
                        if (c & 128) {
                            (s = new Error(
                                `Subscribe error: ${$t.ReasonCodes[c]}`
                            )),
                                (s.code = c);
        ...
        var _1 = (t) => !Jd.has(t),
            ...
            aa = class t {
                ...
                constructor(e, r) {
                    if (!t.#l)
                        throw new TypeError(
                            "instantiate Stack using Stack.create(n)"
                        );
            ...
            la = class t {
                ...
                *rvalues() {
                ...
                has(e, r = {}) {
                    let { updateAgeOnHas: i = this.updateAgeOnHas, status: n } =
                            r,
                        o = this.#n.get(e);
                    if (o !== void 0) {
                        let s = this.#e[o];
                        if (this.#t(s) && s.__staleWhileFetching === void 0)
                            return !1;
                        if (this.#d(o)) n && ((n.has = "stale"), this.#A(n, o));
                        else
                            return (
                                i && this.#T(o),
                                n && ((n.has = "hit"), this.#A(n, o)),
                                !0
                            );
                    } else n && (n.has = "miss");
                    return !1;
                ...
                async fetch(e, r = {}) {
                    let {
                        ...
                        noDeleteOnFetchRejection: d = this
                            .noDeleteOnFetchRejection,
                        allowStaleOnFetchRejection: g = this
                            .allowStaleOnFetchRejection,
        ...
        var mr = class t extends k1.RandomIterator {
            ...
            wa = class extends P1.default {
                ...
                insert(e, r, i = 1) {
                    ...
                    return (
                        this.J.splice(e, 0, ...new Array(i).fill(r)),
                        (this.i += i),
                        this.i
                    );
                }
    ...
    var op = M((Vn) => {
        ...
        var Sr = class t extends D1.RandomIterator {
            ...
            ma = class extends q1.default {
                ...
                getElementByPos(e) {
                    if (e < 0 || e > this.i - 1) throw new RangeError();
                    let { curNodeBucketIndex: r, curNodePointerIndex: i } =
                        this.O(e);
                    return this.A[r][i];
                }
                setElementByPos(e, r) {
                    if (e < 0 || e > this.i - 1) throw new RangeError();
                    let { curNodeBucketIndex: i, curNodePointerIndex: n } =
                        this.O(e);
                    this.A[i][n] = r;
                }
                insert(e, r, i = 1) {
        ...
        var lp = ap(),
            ...
            Ea = class extends W1.Container {
                ...
                updateKeyByIterator(e, r) {
                    let i = e.o;
                    if (
                        (i === this.h && (0, up.throwIteratorAccessError)(),
                        this.i === 1)
                    )
                        return (i.u = r), !0;
                    if (i === this.h.U)
    ...
    var yp = M((Xn) => {
        ...
        var gp = xa(),
            ...
            Ar = class t extends gp.HashContainerIterator {
                ...
                get pointer() {
                    return (
                        this.o === this.h && (0, rv.throwIteratorAccessError)(),
                        this.o.u
                    );
                }
                copy() {
    ...
    var Ap = M((Bi) => {
        ...
        var Av = Ti(),
            ...
            Rv = (t, e) => {
                ...
                if (
                    (clearTimeout(t.connackTimer),
                    delete t.topicAliasSend,
                    e.properties)
                ) {
                    ...
                    h.addEventListener("message", function (S) {
                        ...
                        if (r(E)) {
                            ...
                            var pe = Q.timerId,
                                Yt = Q.timerType;
                            c.delete(z),
                                Yt === "interval" ? a.delete(pe) : l.delete(pe);
                        } else {
            ...
            Fa = class {
                ...
                setKeepalive(e) {
                    ...
                    (this._keepalive = e),
                        this.reschedule(),
                        this.client.log(
                            `KeepaliveManager: set keepalive to ${e}ms`
                        );
                }
                destroy() {
            ...
            ss = class t extends Zv.TypedEventEmitter {
                ...
                constructor(e, r) {
                    ...
                    for (let i in $p)
                        typeof this.options[i] > "u"
                            ...
                            : (this.options[i] = r[i]);
                    (this.log =
                        this.options.log || (0, Jv.default)("mqttjs:client")),
                        ...
                        (this.outgoingStore =
                            r.outgoingStore || new ii.default()),
                        (this.incomingStore =
                            r.incomingStore || new ii.default()),
                        (this.queueQoSZero =
                        ...
                        this.on("connect", () => {
                            let { queue: i } = this,
                                n = () => {
                                    ...
                                    s.messageId &&
                                        s.messageId !== 0 &&
                                        (this.messageIdProvider.register(
                                            s.messageId
                                        ) ||
                                            (a = !1)),
                                        a
                ...
                connect() {
                    ...
                    let s = () => {
                            ...
                            if (h)
                                ...
                                let d = n;
                                (n = null),
                                    this.log("work :: done flag is %s", !!d),
                                    d && d();
                            }
                        },
                        a = () => {
                    ...
                    if (
                        (this.options.will &&
                            (c.will = Object.assign(
                                Object.assign({}, this.options.will),
                                {
                                    payload:
                                        (e = this.options.will) === null ||
                                        e === void 0
                                            ? void 0
                                            : e.payload,
                                }
                        ...
                        this.topicAliasRecv &&
                            ...
                            this.topicAliasRecv &&
                                (c.properties.topicAliasMaximum =
                ...
                subscribe(e, r, i) {
                    ...
                    if (
                        (Array.isArray(e)
                            ? e.forEach((y) => {
                                  this.log("subscribe: array topic %s", y),
                                      d(y);
                              })
                    ...
                    let g = () => {
                        ...
                        if (
                            (c && (w.properties = c), this.options.resubscribe)
                        ) {
                ...
                _removeTopicAliasAndRecoverTopicName(e) {
                    ...
                    if (
                        ...
                        if (
                            ((i = this.topicAliasSend.getTopicByAlias(r)),
                            typeof i > "u")
                        )
                            return new Error("Unregistered Topic Alias");
                        e.topic = i;
                            ...
                            if (r) {
                                ...
                                i.length !== 0 &&
                                    (this.options.autoAssignTopicAlias
                                        ? ((r =
                                              this.topicAliasSend.getAliasByTopic(
                                                  i
                                              )),
                                          r
                                              ? ((e.topic = ""),
                                              ...
                                              : ((r =
                                                    this.topicAliasSend.getLruAlias()),
                                                this.topicAliasSend.put(i, r),
                                                (e.properties = Object.assign(
                                                    Object.assign(
                                                        {},
                ...
                _writePacket(e, r) {
                    ...
                    this.log("_writePacket :: writeToStream result %s", i),
                        !i && r && r !== this.noop
                            ...
                            : r &&
                              (this.log("_writePacket :: invoking cb"), r());
                }
                _sendPacket(e, r, i, n) {
                    this.log(
                        "_sendPacket :: (%s) ::  start",
        ...
        Xp = _e(() => {
            ...
            (Kp = function (t, e) {
                ...
                (Gp = function (t) {
                    ...
                    s < 0 && (s = 0);
                    for (let l = 0; l < s; ++l)
                        t.charCodeAt(l) >= 128 && Rr("not-basic"),
                    ...
                    return (
                        ...
                        typeof t == "object"
                            ? Object.keys(t)
                                  ...
                                  .join(e)
                            : i
                            ? encodeURIComponent(Mi(i)) +
                              r +
                              encodeURIComponent(Mi(t))
                            : ""
                    );
                }),
                (pt = {});
        ...
        var n = {
            ...
            relative: function (s, a) {
                if (
                    ...
                    e(a),
                    s === a ||
                        ((s = n.resolve(s)), (a = n.resolve(a)), s === a))
                )
                    return "";
...
`,
    ...
    var ls = M((li) => {
        ...
        var ol = class extends eS.Duplex {
            ...
            writeToProxy(e, r, i) {
                this.proxy.write(e, r) === !1
                    ? this.proxy.once("drain", i)
                    : i();
            }
            processWriteQueue() {
    ...
    var Ui = M((Qt) => {
        ...
        function Sg(t) {
            ...
            return (
                t.port ||
                    (t.protocol === "wss" ? (e.port = 443) : (e.port = 80)),
                t.path || (e.path = "/"),
    ...
    var kg = M((Br) => {
        ...
        var LS = cs(ot()),
            ...
            qS = cs(Oi());
        typeof (B === null || B === void 0 ? void 0 : B.nextTick) !=
            "function" && (B.nextTick = setImmediate);
        ...
        function Pg(t, e) {
            ...
            if (
                ...
                e.unixSocket
                    ...
                    : !(
                          !((n = e.protocol) === null || n === void 0) &&
                          n.startsWith("ws")
                      ) &&
                      !(
                          !((o = e.protocol) === null || o === void 0) &&
                          o.startsWith("wx")
                      ) &&
                      delete e.path,
                DS(e),
                ...
                if (e.protocol) {
                    if (
                        ["mqtts", "wss", "wxs", "alis"].indexOf(e.protocol) ===
                        -1
                    )
                        switch (e.protocol) {
                            case "mqtt":
            ...
            function s(l) {
                return (
                    e.servers &&
                        ((!l._reconnectCount ||
                            l._reconnectCount === e.servers.length) &&
                            (l._reconnectCount = 0),
